...
import { IconPlus, IconEdit, IconTrash } from "../../assets/svg/index";
        ...
        <div className="box__chb">
          ...
          <div className="box__chb-btn">
            ...
            <button className="box__chb-btn-clk active">
              <Link className="text__box_white" to="/boxdatatype">
                Loại điểm
              </Link>
            </button>
          </div>
        ...
        <div className="box__sbj">
          ...
          <div className="table-type">
            ...
            >
              ...
              <button className="box__btn-del-cancel" onClick={handleDelCancel}>
                Hủy
              </button>
              <button className="box__btn-del-acp" onClick={handleDelCancel}>
                Lưu
              </button>
            </Modal>
          </div>

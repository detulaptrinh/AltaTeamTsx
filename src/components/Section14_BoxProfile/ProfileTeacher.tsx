              ...
              <div className="box">
                <div className="btn-delete">
                  ...
                  >
                    ...
                    <button
                      className="box__btn-del-cancel" /* onClick={handleCancel} */
                    >
                      Hủy
                    </button>
                    <button
                      className="box__btn-del-acp" /* onClick={handleOk} */
                    >
                      Lưu
                    </button>
                  </Modal>
                  ...
                  <Row>
                    ...
                    <Col className="mt1" span={8}>
                      ...
                      <Row className="ant-row-text">
                        ...
                        <Col className="text-right" span={16}>
                          45 Bà Huyện Thanh Quan Q.1 TP.HCM
                        </Col>
                      </Row>
                      <Row className="ant-row-text">
                        <Col className="text-left" span={8}>
              ...
              <Row>
                ...
                <Col className="mleft" span={18}>
                  ...
                  <Row>
                    <Col span={8}>
                      <Row className="ant-row-text">
                        <Col className="communications-text-left">
                          CMND/CCND:
                        </Col>
                        <Col className="communications-text-right">
                          87456 - xxxx - xxxx
                        </Col>
                      </Row>
                      <Row className="ant-row-text">

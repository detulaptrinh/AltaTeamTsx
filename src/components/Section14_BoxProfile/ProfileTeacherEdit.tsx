                      ...
                      <Row>
                        <Col span={9}>
                          <Row className="ant-row-text">
                            ...
                            <Col className="text-right" span={12}>
                              <Input className="input__textr__profile"  defaultValue="MGV89K1095"></Input>
                            </Col>
                          </Row>
                          <Row>
                          ...
                          <Row className="ant-row-text">
                            ...
                            <Col className="text-right-edit" span={12}>
                              <Select defaultValue="Toán - Lý - Hóa" style={{width:210}}>
                                <Option value="Toán - Lý - Hóa">Toán - Lý - Hóa</Option>
                                <Option value="Toán - Lý - Hóa">Toán - Lý - Hóa</Option>
                                <Option value="Toán - Lý - Hóa">Toán - Lý - Hóa</Option>
                              </Select>
                            </Col>
                          ...
                          <Row className="ant-row-text">
                            ...
                            <Col className="text-right-edit" span={12}>
                              <Select defaultValue="Trần Nhựt Minh" style={{width:210}}>
                        ...
                        <Col className="box__right__mr" span={7}>
                          ...
                          <Row className="ant-row-text">
                            ...
                            <Col className="text-right-edit" span={12}>
                              <Select defaultValue="Đang giảng dạy" style={{width:210}}>
                        ...
                        <Col className="mt" span={8}>
                          ...
                          <Row className="ant-row-text">
                            ...
                            <Col className="text-right-edit" span={16}>
                              <Select defaultValue="45 Bà Huyện Thanh Quan" style={{width:210}}>
                                <Option value="45 Bà Huyện Thanh Quan">45 Bà Huyện Thanh Quan</Option>
                                <Option value="45 Bà Huyện Thanh Quan">45 Bà Huyện Thanh Quan</Option>
                              </Select>                    
                            </Col>
                          </Row>
                          <Row className="ant-row-text">
                            ...
                            <Col className="text-right-edit" span={16}>
                              <Select defaultValue="nhtminh@gmail.com" style={{width:210}}>
                                <Option value="nhtminh@gmail.com">nhtminh@gmail.com</Option>
                                <Option value="nhtminh@gmail.com">nhtminh@gmail.com</Option>
                              </Select>  
                            </Col>
                          </Row>
                          <Row className="ant-row-text">
                            ...
                            <Col className="text-right-edit" span={16}>
                            <Select defaultValue="0922922159" style={{width:210}}>
                  ...
                  <Row>
                    ...
                    <Col className="mleft" span={18}>
                      ...
                      <Row>
                        <Col span={8}>
                          <Row className="ant-row-text">
                            <Col className="communications-text-left-edit">Giới tính:</Col>
                            <Col className="communications-text-right-edit">
                              <Input className="input__textr__profile"  defaultValue="Nam" />
                            </Col>
                          </Row>
                          <Row className="ant-row-text">
                            <Col className="communications-text-left-edit">Dân tộc:</Col>
                            <Col className="communications-text-right-edit">
                              <Input className="input__textr__profile"  defaultValue="Kinh"/>
                            </Col>
                          </Row>
                          <Row className="ant-row-text">
                            <Col className="communications-text-left-edit">Ngày vào trường:</Col>
                            <Col className="communications-text-right-edit">
                              <Input className="input__textr__profile"  defaultValue="16/04/2000" />
                            </Col>
                          </Row>
                        </Col>
                        <Col span={8}>
                          ...
                          <Row className="ant-row-text">
                            <Col className="communications-text-left-edit">Ngày vào Đoàn:</Col>
                            <Col className="communications-text-right-edit">
                              <Input className="input__textr__profile"  defaultValue="16/04/2000" />
                            </Col>
                          </Row>
                  ...
                  <Row>
                    ...
                    <Col className="mleft" span={18}>
                      <Row>
                        ...
                        <span className="ant-col-title mt1 ">Thông tin gia đình</span>
                        </Col>
                        <Col className="mt2" span={4}>
                          <button className="btn__profile" onClick={showModals}>Thêm</button>
                          <Modal

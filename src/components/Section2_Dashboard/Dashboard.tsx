                ...
                <div className="overview_content_currentCourse">
                    <div className="choose_schoolYear">
                        <form action="">
                            ...
                            <Select className="arrow__fix" id="choose_year" defaultValue="2020-2021">
                ...
                <div className="statistics">
                    <div className="result_study">
                        <div className="result_study_header">
                            ...
                            <form action="">
                                <Select className="arrow__fix" id="choose_block" defaultValue="Chọn khóa">
                                    <Option value="2017-2018">2017-2018</Option>
                                    <Option value="2018-2019">2018-2019</Option>
                                    <Option value="2019-2020">2019-2020</Option>
                    ...
                    <div className="count_students">
                        <div className="count_students_header">
                            ...
                            <form action="">
                                <Select className="arrow__fix" id="choose_level" defaultValue="THCS">

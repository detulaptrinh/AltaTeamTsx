...
const ClassList = (): JSX.Element => {
  ...
  const menu = (
    <Menu className="section6-dropdown-cre">
      <Menu.Item key="0">
        <button className="section6-dropdown-cre-btn" onClick={showUploadModal}>
          Tải file lên
        </button>
      </Menu.Item>
      <Menu.Item key="1">
        <button className="section6-dropdown-cre-btn" onClick={showImportModal}>
          Nhập thủ công
        </button>
      </Menu.Item>
    </Menu>
      ...
      <div className="section-6">
        ...
        <div className="box__chb">
          ...
          <div className="box__chb-btn">
            ...
            <button className="box__chb-btn-clk active">
              <Link className="text__box_white" to="/boxdataclass">
                Lớp học
              </Link>
            </button>
            <button className="box__chb-btn-clk">
        ...
        <div className="box__btn">
          ...
          <div className="box__btn-button">
            ...
            <button className="box__btn-button_export">Xuất File</button>
            <Dropdown
            ...
            >
              <a className="ant-dropdown-link">
                <img
                  className="box__btn-button_cre-icon"
                  src={IconPlus}
                  alt=""
            ...
            >
              ...
              <div className="box__btn-upload-fileattach">
                ...
                <button className="box__btn-upload-fileattach__btn2">
                  Chọn tệp tải lên...
                </button>
              </div>
              ...
              <button
                className="box__btn-upload-cancel"
                onClick={handleUploadCancel}
              >
                Hủy
              </button>
              <button className="box__btn-upload-acp" onClick={handleUploadOk}>
                Tải lên
              </button>
            </Modal>

            <Modal
              className="section-6-modal2"
              ...
              <Form>
                ...
                <div className="box__btn-import-school">
                  <div className="box__btn-import-block1">
                    ...
                    <Select
                      className="box__btn-import_year"
                ...
                <div className="box__btn-import-list">
                  ...
                  <div className="box__btn-import-list-slct">
                    <Select
                      className="box__btn-import-list-select"
        ...
        <div className="box__sbj">
          <div className="box__sbj-stu">
            ...
            <input
              className="box__sbj-search__input"
              type="search"
